    ...
    public class CABLine
    {
        ...
        public void DrawABLines()
        {
            ...
            if (mf.isSideGuideLines && mf.camera.camSetDistance > mf.tool.width * -120)
            {
                ...
                {
                    GL.Vertex3((cosHeading * ((mf.tool.width - mf.tool.toolOverlap) * (howManyPathsAway + i))) + refPoint1.easting, (sinHeading * ((mf.tool.width - mf.tool.toolOverlap) * (howManyPathsAway + i))) + refPoint1.northing, 0);
                    GL.Vertex3((cosHeading * ((mf.tool.width - mf.tool.toolOverlap) * (howManyPathsAway + i))) + refPoint2.easting, (sinHeading * ((mf.tool.width - mf.tool.toolOverlap) * (howManyPathsAway + i))) + refPoint2.northing, 0);
                }
                */
